...
class kFoldCrossValidation extends baseModal {
    static dialogId = 'kFoldCrossValidation'
    static t = baseModal.makeT(kFoldCrossValidation.dialogId)

    constructor() {
        var config = {
            id: kFoldCrossValidation.dialogId,
            label: kFoldCrossValidation.t('title'),
            modalType: "two",
            RCode: `
require(caret)
   ...
   cat("There was an error when training the model")
        ...
        var objects = {
            modelname: {
                el: new input(config, {
                    no: 'modelname',
                    label: kFoldCrossValidation.t('modelname'),
                    placeholder: "",
            ...
            folds: {
                el: new input(config, {
                    no: 'folds',
                    label: kFoldCrossValidation.t('folds'),
                    placeholder: "",
                    allow_spaces:true,
                    extraction: "NoPrefix|UseComma",
                    required: true,
            ...
            dependent: {
                el: new dstVariable(config, {
                    label: kFoldCrossValidation.t('dependent'),
                    no: "dependent",
            ...
            independent: {
                el: new dstVariableList(config, {
                    label: kFoldCrossValidation.t('independent'),
                    no: "independent",
                    filter: "String|Numeric|Date|Logical|Ordinal|Nominal|Scale",
                    extraction: "NoPrefix|UseComma|Enclosed",
                    required: true,
            ...
            label1: { el: new labelVar(config, { label: kFoldCrossValidation.t('label1'), style:"mt-3",h: 6 }) },
            ModelType: {
                el: new comboBoxWithChilderen(config, {
                    no: 'ModelSelection',
                    nochild: 'combokid',
                    label: kFoldCrossValidation.t('ModelSelection'),
                    multiple: false,
                    required: true,
                    extraction: "NoPrefix|UseComma",
                    options: [
            ...
            levelOfInterest: {
                el: new comboBox(config, {
                    no: 'levelOfInterest',
                    label: kFoldCrossValidation.t('levelOfInterest'),
                    multiple: false,
                    extraction: "NoPrefix|UseComma",
                    options: [],
                    default: ""
        ...
        const content = {
            ...
            nav: {
                name: kFoldCrossValidation.t('navigation'),
                icon: "icon-k_fold",
                modal: config.id
            }
        }
...
module.exports = {
    render: () => new kFoldCrossValidation().render()
}
